...
public final class SdkLogicServer extends AbstractBrokerClientStartup {
    ...
    private void extractedDoc(BarSkeletonBuilder builder) {
        builder.addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.triggerBroadcast))
                // broadcast type
        ...
        builder.addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastInt))
                .setDataClass(IntValue.class, "biz data description")
                .setMethodDescription("IntValue method description")
                .setMethodName("IntValue")
        ).addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastLong))
                .setDataClass(LongValue.class)
                .setMethodDescription("LongValue")
                .setMethodName("LongValue")
        ).addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastBool))
                .setDataClass(BoolValue.class)
                .setMethodDescription("BoolValue")
                .setMethodName("BoolValue")
        ).addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastString))
                .setDataClass(StringValue.class)
                .setMethodDescription("StringValue")
                .setMethodName("StringValue")
        ).addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastValue))
        ...
        ).addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastListLong))
                .setDataClassList(LongValue.class)
                .setMethodDescription("LongValueList")
                .setMethodName("LongValueList")
        ).addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastListBool))
                .setDataClassList(BoolValue.class)
                .setMethodDescription("BoolValueList")
                .setMethodName("BoolValueList")
        ).addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastListString))
                .setDataClassList(StringValue.class)
                .setMethodDescription("StringValueList")
                .setMethodName("StringValueList")
        ).addBroadcastDocument(BroadcastDocument.newBuilder(SdkCmd.of(SdkCmd.broadcastListValue))
