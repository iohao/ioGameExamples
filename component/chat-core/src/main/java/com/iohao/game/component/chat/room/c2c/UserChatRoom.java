 ...
 * @date 2023-07-16
 */
public interface UserChatRoom extends MicroRoom {
     ...
     */
    void receivePrivate(ChatMessage chatMessage);
     ...
     */
    List<ChatMessage> readPrivate(long senderId);
