 ...
 */
package com.iohao.game.example.ext.monitor.server;
...
import com.iohao.game.example.ext.monitor.action.DemoExtAction;

/**
 * @author 渔民小镇
 * @date 2022-06-04
 */
public class DemoExtLogicServer extends AbstractBrokerClientStartup {
    @Override
    public BarSkeleton createBarSkeleton() {
        // 业务框架构建器 配置
        var config = new BarSkeletonBuilderParamConfig()
                // 扫描 DemoAction.class 所在包
                .addActionController(DemoExtAction.class);
