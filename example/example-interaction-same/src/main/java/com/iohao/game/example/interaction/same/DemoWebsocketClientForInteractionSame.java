...
public class DemoWebsocketClientForInteractionSame {
    ...
    public static void main(String[] args) throws URISyntaxException {
        DemoWebsocketClientForInteractionSame websocketClient = new DemoWebsocketClientForInteractionSame();
    ...
    private void init() throws URISyntaxException {
        ...
        WebSocketClient webSocketClient = new WebSocketClient(new URI(wsUrl), new Draft_6455()) {
            ...
            public void onOpen(ServerHandshake serverHandshake) {
                ...
                // 路由, 对应服务端逻辑服的业务类路由地址
                int cmd = DemoCmdForHall.cmd;
                int subCmd = DemoCmdForHall.count;
