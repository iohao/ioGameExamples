 ...
 */
package com.iohao.game.example.hook.server;
...
import com.iohao.game.example.hook.action.DemoHookRoomAction;

/**
 * @author 渔民小镇
 * @date 2022-05-28
 */
public class DemoHookRoomServer extends AbstractBrokerClientStartup {
    @Override
